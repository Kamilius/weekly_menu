...
app.controller("CalendarCtrl", [ "$scope", "recipeService", function($scope, recipeService) {
    var calendar;
    $scope.weeklyMenu = [];
...
app.controller("RecipesCRUDCtrl", [ "$scope", "$routeParams", "recipeService", function($scope, $routeParams, $recipeService) {
    $scope.recipes = $recipeService.recipes;
