...
app.controller("CalendarCtrl", [ "$scope", "$http", "$filter", "recipeService", function($scope, $http, $filter, $recipeService) {
    var buildWeek, currentWeek, currentYear, dayNames, getDateOfISOWeek, getDayByDate, getDayByName, init, recipeInMeal, removeAllRecipesById;
    ...
    init = function() {
        var calendar;
        buildWeek();
        $http.get("/api/calendar/" + encodeURIComponent($scope.weeklyMenu[0].date.toLocaleDateString())).success(function(data) {
