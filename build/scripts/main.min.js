    ...
    a = b.module("ngRoute", [ "ng" ]).provider("$route", function() {
        ...
        this.when = function(a, e) {
            ...
            function m() {
                ...
                (s.current = d) && d.redirectTo && (b.isString(d.redirectTo) ? f.path(o(d.redirectTo, d.params)).search(d.params).replace() : f.url(d.redirectTo(d.pathParams, f.path(), f.search())).replace()), 
                h.when(d).then(function() {
                    if (d) {
                        ...
                        b.isDefined(a) && (e.$template = a), h.all(e);
                    }
                }).then(function(e) {
            ...
            var p, q, r = !1, s = {
                ...
                updateParams: function(a) {
                    ...
                    }), a = b.extend({}, this.current.params, a), f.path(o(this.current.$$route.originalPath, a)), 
                    f.search(b.extend({}, f.search(), c));
                }
            };
