...
app.controller("RecipesCRUDCtrl", [ "$scope", "$routeParams", "$location", "$rootScope", "$http", function($scope, $routeParams, $location, $rootScope, $http) {
...
app.controller("SummaryCtrl", [ "$scope", "$http", "$filter", function($scope, $http, $filter) {
    var initSummary;
    $scope.weeklySummary = {};
...
app.service("recipeService", [ "$rootScope", function($rootScope) {
