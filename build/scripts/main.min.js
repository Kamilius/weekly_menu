...
app.controller("CalendarCtrl", [ "$scope", "$http", "$filter", "recipeService", function($scope, $http, $filter, $recipeService) {
    var buildWeek, currentWeek, currentYear, dayNames, getDateOfISOWeek, getDayByDate, getDayByName, getRecipesForCurrentWeek, init, recipeInMeal, removeAllRecipesById, todayDate;
...
app.controller("SummaryCtrl", [ "$scope", "recipeService", function($scope, $recipeService) {
