...
app.controller("CalendarCtrl", [ "$scope", "recipeService", "$rootScope", "calendarService", function($scope, $recipeService, $rootScope, $calendarService) {
    var calendar;
...
app.controller("IngredientsCtrl", [ "$scope", "ingredientsService", "$rootScope", "recipeService", function($scope, $ingredientsService, $rootScope, $recipeService) {
...
app.controller("RecipesCtrl", [ "$scope", "recipeService", "calendarService", function($scope, $recipeService, $calendarService) {
...
app.controller("RecipesCRUDCtrl", [ "$scope", "$routeParams", "recipeService", "$location", "$rootScope", "ingredientsService", function($scope, $routeParams, $recipeService, $location, $rootScope, $ingredientsService) {
    var recipe;
    $scope.recipes = $recipeService.recipes;
    $scope.ingredients = $ingredientsService.items;
    $scope.ingModel = {
...
var DayOfWeek, Ingredient, Recipe, RecipeIngredient, WeekSummary;
...
app.service("calendarService", [ "recipeService", "$rootScope", "$filter", function($recipeService, $rootScope, $filter) {
...
app.service("ingredientsService", [ "$rootScope", function($rootScope) {
