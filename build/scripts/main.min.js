...
app.controller("CalendarCtrl", [ "$scope", "recipeService", "$rootScope", function($scope, recipeService, $rootScope) {
    var calendar;
    $scope.weeklyMenu = [];
...
app.controller("RecipesCtrl", [ "$scope", "recipeService", function($scope, recipeService) {
